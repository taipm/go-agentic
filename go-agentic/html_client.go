...
<head>
    ...
    <title>go-agentic SSE Streaming Client</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h1>🚀 go-agentic SSE Streaming Client</h1>
        <p class="subtitle">Real-time crew execution with Server-Sent Events</p>

        <div class="input-group">
            <input type="text" id="queryInput" placeholder="Enter your request (e.g., 'What are the latest trends?')" />
